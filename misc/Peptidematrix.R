...
#data = read.table("Cas 9 Shay.csv",header=T,sep=",")
data = read.table("NonA2-HLAs Training seq.csv",header=T,sep=",")
#data = read.table("NonA2-HLAs testing seq.csv",header=T,sep=",")
...
write.table(matrixx[[1]],file ="NonA2-HLAs training numeric.txt", sep = "\t", col.names = NA, qmethod = "double")